...
public class LatLngDistanceKeeper {
    ...
    public LatLngDistanceKeeper(LatLng value, ImageView IV, int IVID, TextView TV, int TVID) {
        this.valueinObject = value;
        this.distanceFromPointer = 0;
        this.counter++;
        this.anotherCounter = counter;
        this.reasonForMarked = "Marked for Testing Purposes "+this.anotherCounter;
